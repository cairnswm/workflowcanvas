...
import { Activity, Database, GitFork, Square, Trash2, MessageCircle } from 'lucide-react';
...
function WorkflowNode({ id, data }: { id: string; data: NodeData }) {
  ...
  if (data.type === 'decision') {
    return (
      <>
        <div className={`relative px-4 py-2 shadow-lg rounded-md border-2 ${getNodeStyle()}`}>
          <Handle
            type="target"
